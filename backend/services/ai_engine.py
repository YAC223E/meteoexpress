...
class WeatherAI:
    ...
    def generate_recommendations(self, weather_data, lang="fr"):
        ...
        rec = {
            ...
            "summary":        self._generate_summary(temp, condition, wind, lang),
            # Expanded fields
    ...
    def _generate_summary(self, temp, condition, wind, lang="fr"):
        if lang == "en":
            en_summaries = {
                "Clear":       f"Beautiful sunny day at {temp}°C. Perfect for outdoor activities!",
        ...
        summaries = {
            "Clear":       f"Belle journée ensoleillée avec {temp}°C. Parfait pour les activités d'extérieur !",
...
- "clothing": array of 3-5 specific clothing suggestions with emojis (in the response language)
...
- "pack": array of 3-5 practical items to bring with emojis (language matching)
...
- "clothing": array of 3-5 short clothing suggestions with emojis
- "activities": object with "icon" (emoji) and "activities" (array of 3-5 short activity strings)
- "travel": short driving/travel advice string with emoji
- "pack": array of 3-5 practical items to bring with emojis
